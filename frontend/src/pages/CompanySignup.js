...
import { Mail, Lock, Eye, EyeOff, Building2, Phone, MapPin } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-eco-50 to-primary-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Register your company with E-Waste Loop</p>
        </div>
        ...
        <div className="card">
          ...
          <div className="mt-6 text-center space-y-2">
            ...
            <p className="text-gray-600">
              ...
              <Link to="/user/signup" className="text-primary-600 hover:text-primary-700 font-medium">
                User Signup
              </Link>
            </p>
          </div>
